...
static void vfio_pci_save_config(PCIDevice *pdev, QEMUFile *f)
{
    qemu_put_buffer(f, pdev->config, pci_config_size(pdev));
}

static void vfio_pci_load_config(PCIDevice *pdev, QEMUFile *f)
{
